import { handleConfirmAndSignUp } from "./fetches/handleConfirmAndSignUp.js";
...
export function buildConfirmUserInformationSection(signupObject, serverURL) {
  ...
  confirmDetailsBtn.addEventListener("click", (e) => handleConfirmAndSignUp(e, serverURL, signupObject));
